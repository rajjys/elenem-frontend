                ...
                <div className="md:flex">
                    <div className="md:w-1/3 md:flex-shrink-0">
                        <div className="relative h-48 w-full md:h-full">
                            <Image
                                src={tenant.businessProfile.bannerImageUrl || `https://placehold.co/600x400/eee/ccc?text=${tenant.name}`}
                    ...
                    <div className="md:w-2/3 p-6 flex flex-col bg-card">
                        ...
                        <p className="text-muted-foreground text-sm line-clamp-2 flex-grow">
                            {tenant.businessProfile.description || 'A leading organization in the world of sports.'}
                        </p>
