...
export function RegisterForm() {
  ...
  const onSubmit = async (values: RegisterFormValues) => {
    ...
    try {
      ...
      router.push(`/verify-email?email=${encodeURIComponent(values.email)}&sent=1`);
    } catch (error) {
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <CountryDropdown
                            ...
                            className="w-full h-10 border border-line bg-canvas px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-ink-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                          />
                        </FormControl>
