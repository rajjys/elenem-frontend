...
interface Step2TenantBusinessProfileProps {
...
export function Step2TenantBusinessProfile({
  form,
  logoInputRef,
  bannerInputRef,
  logoPreview,
  ...
  ownersLoading,
  isSystemAdmin
}: Step2TenantBusinessProfileProps) {
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {isSystemAdmin && (
          <div className="space-y-2 col-span-2">
            ...
            {errors.ownerId && <p className="text-negative text-xs">{errors.ownerId.message}</p>}
          </div>
        )}
      </div>
