  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-2 py-1 rounded-full border border-gray-200 nav-hover transition-all duration-150 dark:text-gray-100"
      >
        {userAuth.profileImageUrl ? (
          ...
          <FiUser className="w-6 h-6 p-1 rounded-full border" />
        )}
      ...
      {dropdownOpen && (
        <div className="absolute right-0 mt-2 w-52 rounded-md shadow-xl bg-white dark:bg-slate-950 dark:text-gray-200 ring-1 ring-black/5 dark:ring-slate-700 z-40 animate-fadeIn">
          <div>
