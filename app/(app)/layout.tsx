...
function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gray-800 text-white p-4 space-y-2">
      ...
      <Link href="/teams" className="block hover:bg-gray-700 p-2 rounded">Teams</Link>
      <Link href="/games" className="block hover:bg-gray-700 p-2 rounded">Games</Link>
      <Link href="/players" className="block hover:bg-gray-700 p-2 rounded">Games</Link>
      <Link href="/statistics" className="block hover:bg-gray-700 p-2 rounded">Statistics</Link>
      <Link href="/referees" className="block hover:bg-gray-700 p-2 rounded">Referees</Link>
      <Link href="/more" className="block hover:bg-gray-700 p-2 rounded">More</Link>
