...
export default function PricingPage() {
  return (
    <div className="bg-surface selection:bg-primary/10">

      {/* HERO: High Impact & Clean */}
      <section className="relative py-24 lg:py-32 overflow-hidden">
        {/* Subtle Background Accent */}
        <div className="absolute top-0 right-0 w-1/3 h-full bg-surface-sunk -skew-x-12 translate-x-1/2 -z-10" />
        <Container>
        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-xl">
              <h2 className="text-3xl font-black text-ink tracking-tight mb-6">
                Pricing based on how <br/>your league operates
              </h2>
              
              <div className="space-y-4 text-ink-muted text-lg leading-relaxed">
                <h3 className="text-lg text-ink mb-2 italic font-medium">
                ...
                <div className="bg-surface-sunk p-6 rounded-2xl border border-line">
                  <p className="font-bold text-ink mb-4 text-sm uppercase tracking-wider">Elenem pricing reflects:</p>
            ...
            <div className="hidden lg:block relative">
               <div className="aspect-square bg-surface-sunk rounded-[3rem] border border-line flex items-center justify-center">
                  <ShieldCheck size={120} className="text-ink-inverted" />
               </div>
            </div>
          </div>
        </Container>
      ...
      <section className="py-24 bg-slate-900">
        <Container>
          <div className="max-w-5xl mx-auto">
            <div className="bg-surface rounded-[2.5rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.3)] overflow-hidden">
              <div className="grid lg:grid-cols-5">
                ...
                <div className="lg:col-span-3 p-8 lg:p-14">
                  ...
                  <h2 className="text-4xl font-black text-ink mb-6 tracking-tight leading-tight">
                ...
                {/* Pricing Side */}
                <div className="lg:col-span-2 bg-surface-sunk border-l border-line p-8 lg:p-14 flex flex-col justify-center items-center text-center">
                  <p className="text-ink-subtle font-bold uppercase tracking-widest text-[10px] mb-2">Starts at</p>
                  <div className="flex items-baseline gap-1 mb-8">
                    <span className="text-7xl font-black text-ink tracking-tighter">$399</span>
                    <span className="text-ink-subtle font-bold">/season</span>
                  </div>
                  ...
                  <p className="mt-4 text-[10px] text-ink-subtle font-medium">No hidden fees. Pay per competition season.</p>
                </div>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* PRO */}
              <div className="group p-10 rounded-[2rem] border border-line bg-surface hover:border-primary/20 hover:shadow-2xl transition-all duration-500">
                <div className="w-12 h-12 rounded-2xl bg-surface-sunk flex items-center justify-center mb-8 group-hover:bg-primary/5 transition-colors">
                  <TrendingUp className="text-ink-subtle group-hover:text-primary transition-colors" />
                </div>
                <h3 className="text-2xl font-black text-ink mb-4 italic">Pro</h3>
                ...
                <ul className="space-y-4 mb-10">
                  {[
                    ...
                    <li key={i} className="text-sm font-bold text-ink flex items-center gap-3">
              ...
              {/* FEDERATION */}
              <div className="group p-10 rounded-[2rem] border border-line bg-slate-900 text-white shadow-2xl transition-all duration-500">
                <div className="w-12 h-12 rounded-2xl bg-surface/5 flex items-center justify-center mb-8">
                  <Users className="text-primary-light" />
                </div>
                <h3 className="text-2xl font-black text-white mb-4 italic">Federation</h3>
                <p className="text-ink-subtle mb-8 font-medium">
                ...
                <ul className="space-y-4 mb-10">
                  {[
                    ...
                    <li key={i} className="text-sm font-bold text-ink-inverted flex items-center gap-3">
      ...
      <section className="py-24 bg-surface-sunk border-y border-line">
        <Container>
          <div className="grid lg:grid-cols-2 gap-20">
            {/* NOT SOFTWARE */}
            <div>
              <h2 className="text-3xl font-black text-ink mb-8 tracking-tight uppercase italic text-[24px]">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 p-4 rounded-xl bg-surface border border-line shadow-sm">
                      <div className="w-2 h-2 rounded-full bg-primary" />
                      <span className="font-bold text-ink text-sm">{item}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div>
              ...
              <div className="bg-surface p-8 rounded-[2rem] border border-line">
                 <p className="text-ink-muted mb-6 font-medium">Most leagues already pay — just not in money:</p>
                 <ul className="space-y-4 text-ink font-bold text-sm">
                   <li className="flex items-center gap-3 text-negative/80"><Clock size={16} /> Time spent fixing schedule errors</li>
                   <li className="flex items-center gap-3"><ShieldCheck size={16} className="text-ink-subtle"/> Disputes after matchdays</li>
                   <li className="flex items-center gap-3"><Users size={16} className="text-ink-subtle"/> Poor communication with teams</li>
                   <li className="flex items-center gap-3"><TrendingUp size={16} className="text-ink-subtle"/> Limited visibility for sponsors</li>
                 </ul>
                 <div className="mt-4 pt-4 border-t border-line">
                   <p className="text-ink font-black italic">Elenem helps you avoid this.</p>
                 </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-surface">
        <Container>
          <div className="max-w-3xl border-l-4 border-primary pl-8 lg:pl-12">
            ...
            <p className="text-xl text-ink-muted leading-relaxed italic">
              We help configure your league, structure your competition,
              and guide you through onboarding. You focus on running the league. 
              <span className="text-ink font-bold not-italic ml-2">We handle the system.</span>
            </p>
          </div>
        </Container>
      </section>
      ...
      <section className="py-24 bg-slate-900">
        <Container>
          <div className="max-w-4xl text-center mx-auto">
            ...
            <p className="text-ink-subtle text-lg mb-12 max-w-xl mx-auto">
